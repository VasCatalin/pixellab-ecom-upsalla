...
export const OffCanvasMenu = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsMobile(typeof window !== 'undefined' && window.matchMedia('(max-width: 1023px)').matches);
    };
...
>
<ul className={` ${open ? 'opacity-0' : 'opacity-100 delay-300'} menu flex flex-col gap-3 justify-center items-center h-full`}>
